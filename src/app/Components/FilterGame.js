...
const FILTER_ORDER = ['cap', 'noMvps', 'oneFranchise', 'oneDecade', 'randomEra', 'eraMode', 'lebron', 'hard', 'classic'];

// Difficulty colour per filter (label text comes from the locale).
const DIFF_CLASS = {
  classic: 'diffEasy', cap: 'diffHard', noMvps: 'diffMed',
  oneFranchise: 'diffMed', oneDecade: 'diffMed', randomEra: 'diffMed', eraMode: 'diffMed', lebron: 'diffEasy', hard: 'diffHard',
};
